...
public:
	...
	*/
	...
	/*
		SetEndTime
			Parameters:
				Time endTime time that the simulation should end if set
			Return value:
				time _endTime
			Behavior:
				Sets the end of the simulation, used to provide info to other classes
	*/
...
private:
	...
	static Time _endTime;			// Brosche-added to maintain the simulation end time, if specified.
};
