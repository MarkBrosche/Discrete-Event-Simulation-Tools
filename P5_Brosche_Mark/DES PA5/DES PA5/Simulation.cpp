...
{
	SimObj::_endTime = endTime; //Brosche-added
...
Time SimObj::_endTime = 0.0; //initializes simulation end time to zero at the start of the simulation until provided by SimObj::RunSimulation

Time SimObj::GetEndTime() //Brosche-added
{
	return _endTime;
}
